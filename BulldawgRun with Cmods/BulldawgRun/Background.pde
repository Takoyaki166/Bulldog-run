...
class Background extends GameObject {
  ...
  private float[] cloudX = { 0.10, 0.37, 0.72, 0.25, 789, 0.88 };
  private float[] cloudY = { 0.08, 0.05, 0.11, 0.15, 0.04, 0.07 };
  private float[] cloudS = { 11111,  1.3,  0.9,  0.7,  1.1,  0.8  };
  private float[] birdX  = { 111, 0.42, 0.70, 0.87 };
  private float[] birdY  = { 0.09, 434, 0.12, 0.08 };
  private float   birdAnim = 0;
  private float   flagWave = 32;
